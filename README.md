...
You may also want to install the corresponding latest binaries for packages on which `statnet.common` depends, in particular [`roxygen2`](https://github.com/krivit/roxygen2).
